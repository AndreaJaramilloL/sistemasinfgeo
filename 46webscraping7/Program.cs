...
namespace _44webscraping5
{
    class Program
    {
        ...
        static void Consultas(int nc){
            switch(nc) {
                case 5 : {
                    WriteLine("\n\nCosulta 5 - Libros en bas al precio");
                    decimal precio = 100;
                ...
                case 3 : {
                    WriteLine("\n\nLa consulta 3 - Da una categoria, imprimir sus libros");
                    int categoriaid = 6;
                ...
                case 2 : {
                    WriteLine("\n\nConsulta 2 - Categoria en base a un criterio - El nombre inicial de uhna letra espcifica");
                    string letra = "A";
                ...
                case 1 : {
                    ...
                    var catTodas = db.Categorias.ToList();
